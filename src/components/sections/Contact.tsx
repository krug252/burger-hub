      ...
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="animate-on-scroll animate-delay-200 text-xl text-muted-foreground mb-12">
            Dúvidas, sugestões ou só quer bater um papo sobre hambúrguer?
            Estamos aqui!
          </p>

          <div className="animate-on-scroll animate-delay-300 flex flex-wrap justify-center gap-6 mb-12">
          ...
          {/* Social Links */}
          <div className="animate-on-scroll animate-delay-400 flex justify-center gap-4">
            <a
              href="https://instagram.com"
              target="_blank"
              rel="noopener noreferrer"
