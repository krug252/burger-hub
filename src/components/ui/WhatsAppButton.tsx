...
const WhatsAppButton = ({ className, children, size = "default" }: WhatsAppButtonProps) => {
  ...
  return (
    <a
      ...
      className={cn(
        ...
        "accent-gradient text-primary-foreground rounded-lg pulse-glow hover:scale-105",
        size === "lg" ? "px-8 py-4 text-lg" : "px-6 py-3 text-base",
        className
      )}
    >
      <svg
        className={cn("fill-current", size === "lg" ? "w-6 h-6" : "w-5 h-5")}
        viewBox="0 0 24 24"
